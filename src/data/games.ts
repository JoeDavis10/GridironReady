export type GameKind = "relay" | "race" | "reaction" | "team" | "skill";
export type GameIntensity = "moderate" | "high";
...
export const KIND_LABELS: Record<GameKind, string> = {
  relay: "Relay",
  race: "Race",
  reaction: "Reaction",
  team: "Team",
...
export const competitiveGames: CompetitiveGame[] = [
  {
    ...
    equipment: ["12 cones", "2 footballs (optional)", "Whistle"],
    summary:
      "Team relay through Base Box → M → finish sprint. First team to cycle everyone wins.",
    ...
    scoring: [
      "Winner: first team finished",
      "Style bonus: coaches can award a 'cleanest cuts' flag that ties breakers",
    ],
    coachingCues: [
  ...
  },
  {
    ...
    summary:
      "Ball-carrier (air) vs pursuer race to a sideline cone — angle pursuit without tackling.",
    ...
    safety: [
      "Strict no-touch rule on the carrier",
      "Call dead if paths converge dangerously",
    ],
  ...
  },
  {
    ...
    summary:
      "Possession game: advance a ball across a 3×3 cone grid with only lateral shuffles and handoffs.",
  ...
  },
  {
    ...
    summary:
      "Competitive first-step game: different whistle codes mean different directions.",
    ...
    scoring: [
      "Individual tallies or position-group totals",
      "Loser group does 4 perfect push-ups (quality, not punishment grind)",
    ],
    coachingCues: [
  ...
  },
  {
    ...
    summary:
      "Ball-security weave race: high-knee gauntlet with optional soft noodle taps only.",
  ...
  },
  {
    ...
    summary:
      "Leader vs mirror in a box — 20-second bouts, judges score who forced more breaks.",
    ...
    scoring: [
      "Coach or peer scores 1–5 on 'tough to stick'",
      "Highest combined score wins the pair challenge",
    ],
    coachingCues: [
      "Stay in the box",
  ...
  },
  {
    ...
    durationMin: 10,
    players: "4–16",
    equipment: ["4 cones", "4 colored pinnies or numbers", "Whistle"],
    summary:
      "Sprint race to a called corner; last player in is out that round — elimination heat.",
    ...
    safety: [
      "No pushing at the cone",
      "Use large square to reduce congestion",
    ],
  ...
  },
  {
    ...
    durationMin: 12,
    players: "Whole team",
    equipment: ["Field hashes", "Whistle", "Clock"],
    summary:
      "Continuous 110 train: groups leave every 15 seconds; compete for fewest form breaks.",
    ...
    scoring: ["Form flags (−1)", "Missed leave time (−1)", "Highest score wins pride"],
    coachingCues: ["Smooth rhythm", "Relaxed face", "Even splits"],
  ...
  },
  {
    ...
    summary:
      "Race to pull a hanging flag at the finish — pure speed, zero tackling.",
  ...
  },
  {
    ...
    summary:
      "Head-to-head ladder patterns — first team through the card of moves wins.",
  ...
  },
  {
    ...
    summary:
      "Fast mesh handoffs in a moving circle — drop = mini-burst, keep the ball alive.",
    ...
    scoring: [
      "Fewest drops wins the period",
      "Team PR for consecutive clean handoffs",
    ],
    coachingCues: [
  ...
  },
  {
    ...
    equipment: ["Cones for 15-yard box", "Football", "Whistle"],
    summary:
      "Route stem + break + 5-yard burst race — timed pairs, no DB contact.",
  ...
  },
  {
    ...
    summary:
      "Shark tries to tag a cone the fish just left — lateral chase with no body contact.",
    ...
    safety: [
      "Tag cones only — never players",
      "Call freeze if two fish collide on a cone",
    ],
    nonContact: true,
  },
  // —— New camp favorites ——
  {
    ...
    summary:
      "Classic freeze game with football footwork — green = accelerate, red = stick the plant.",
    ...
    scoring: [
      "Heat winners get 1 point",
      "Clean freezes (no wobbles) earn style flags for ties",
    ],
    coachingCues: [
  ...
  },
  {
    ...
    equipment: ["1 towel or soft football midfield", "Cones for lanes", "Number cards"],
    summary:
      "Numbered race to the midfield 'bacon' — grab and score without contact.",
    ...
    safety: [
      "No two-hand wraps, shoulder checks, or dives",
      "Wide score zones to reduce pile-ups",
    ],
  ...
  },
  {
    ...
    equipment: ["Soft football or disc", "End-zone cones", "Pinnies"],
    summary:
      "Ultimate-style possession: complete passes into the end zone — stall count, no contact.",
  ...
  },
  {
    ...
    equipment: ["4 station cones (N/E/S/W)", "Whistle", "Station cards"],
    summary:
      "Team relay around four stations — each station is a different movement tax.",
    ...
    safety: ["Stagger starts", "No diving tags", "Burpees with soft landings"],
    nonContact: true,
  },
  {
    id: "partner-towels",
    ...
    summary:
      "Chaser tries to step on a dragged towel — never the partner. Pure COD fun.",
  ...
  },
  {
    ...
    equipment: ["3–5 target nets/buckets/cones", "Footballs", "Timer"],
    summary:
      "Timed accuracy race: hit targets in order under a shot clock — competition without contact.",
  ...
  },
  {
    ...
    equipment: ["Boards or painted lines", "Whistle", "Finish cone at 5 yards"],
    summary:
      "Head-to-head first-step races off a silent or cadence snap — no contact finish.",
...
export function getGameById(id: string): CompetitiveGame | undefined {
